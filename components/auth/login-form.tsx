      ...
      <div className="relative">
        ...
        {isPassword && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#83827d] hover:text-[#3d3929] transition-colors"
            tabIndex={-1}
    ...
    <div className="overflow-hidden rounded-3xl shadow-2xl shadow-black/40" style={{ background: C.paper }}>
      ...
      >
        <form action={formAction} className="space-y-4">
          ...
          <ChitInput id="password" name="password" type="password" label="Password" autoComplete="current-password" required />
        ...
        <div className="mt-5 border-t border-dashed pt-5" style={{ borderColor: C.border }}>
          <p className="text-center text-sm" style={{ color: C.inkMuted }}>
            New to Parcha?{" "}
            <Link href="/signup" className="font-bold transition-colors hover:underline" style={{ color: C.espresso }}>
              Create an account
            </Link>
          </p>
        </div>
