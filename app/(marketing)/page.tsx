  ...
  return (
    <div className="overflow-x-hidden" style={{ background: C.paper }}>
      ...
      >
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-center gap-16 px-6 pb-0 pt-20 md:flex-row md:items-center md:pt-16 lg:px-16">
          {/* Left — copy */}
